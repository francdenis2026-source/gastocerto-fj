  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        to: "/gas",
        icon: Zap,
        hint: "Gás, energia e veículos",
        children: [
          { key: "consumption.gas", label: "Botijão de gás", to: "/gas", keywords: "glp cozinha" },
          { key: "consumption.energy", label: "Energia elétrica", to: "/energia", keywords: "luz kwh conta" },
          { key: "consumption.vehicles", label: "Veículos e combustível", to: "/veiculos", keywords: "carro moto gasolina etanol" },
          { key: "consumption.vehiclesReport", label: "Relatório de veículos", to: "/veiculos-relatorio", hidden: true, keywords: "consumo km/l" },
          { key: "consumption.vehiclesSettings", label: "Configurações de veículos", to: "/veiculos-configuracoes", hidden: true },
          { key: "consumption.vehiclesAudit", label: "Auditoria de veículos", to: "/veiculos-auditoria", hidden: true },
        ],
      },
    ],
  },
