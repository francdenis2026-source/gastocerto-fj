    ...
    groups: [
      ...
      },
      {
        ...
        children: [
          ...
          { key: "consumption.water", label: "Água e Esgoto", to: "/lancamentos", keywords: "sanepar sabesp casan conta" },
          { key: "consumption.internet", label: "Internet e TV", to: "/lancamentos", keywords: "wifi fibra cabo" },
          { key: "consumption.rent", label: "Aluguel e Moradia", to: "/lancamentos", keywords: "casa condomínio" },
          { key: "consumption.food", label: "Açougue e Feira", to: "/lancamentos", keywords: "carne frutas legumes" },
          { key: "consumption.personal", label: "Barbeiro e Estética", to: "/lancamentos", keywords: "cabelo barba salão" },
          { key: "consumption.gym", label: "Academia e Saúde", to: "/lancamentos", keywords: "treino fitness crossfit" },
          { key: "consumption.recharge", label: "Celular e Recargas", to: "/lancamentos", keywords: "telefone créditos" },
          { key: "consumption.clothing", label: "Vestuário e Moda", to: "/lancamentos", keywords: "roupa calçado" },
          { key: "consumption.leisure", label: "Churrascos e Lazer", to: "/lancamentos", keywords: "fim de semana festa" },
          { key: "consumption.kids", label: "Mesadas e Filhos", to: "/kids", keywords: "dependentes escola" },
          { key: "consumption.others", label: "Outros Serviços", to: "/lancamentos", keywords: "diversos variados" },
        ],
      },
    ],
  },
