        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <Reveal key={i} delay={i * 50}>
              <div className="premium-card interactive-card group h-full bg-slate-50/50 dark:bg-slate-900/40 border-slate-200 dark:border-white/5">
                <div className={`size-12 rounded-2xl ${f.bg} flex items-center justify-center mb-6 transition-transform duration-200 group-hover:scale-105`}>
