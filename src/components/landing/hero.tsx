...
export function Hero() {
  return (
    <section
      id="inicio"
      className="relative isolate flex items-center overflow-hidden bg-hero-bg pt-[5rem] pb-8 text-hero-fg sm:min-h-[50svh] sm:max-h-[650px] sm:pb-12 sm:pt-32 lg:pt-40"
    >
      <img
        src={heroBg}
        alt=""
