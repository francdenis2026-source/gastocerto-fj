  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-20">
        <img 
          src="https://images.unsplash.com/photo-1567427017947-545c5f8d16ad?q=80&w=2670&auto=format&fit=crop" 
          alt="" 
          className="h-full w-full object-cover brightness-[0.4] contrast-[1.2]"
        />
