      ...
      <div className="section-shell relative z-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <Reveal className="space-y-6 sm:space-y-8">
            <h1 className="font-display text-[clamp(2.5rem,10vw,6rem)] font-black leading-[0.95] tracking-tight text-white drop-shadow-2xl px-4 italic">
              Domine seu<br />
              <span className="bg-gradient-to-r from-emerald-400 to-emerald-600 bg-clip-text text-transparent">dinheiro.</span>
            </h1>
            
            <p className="mx-auto max-w-2xl px-6 text-lg font-medium leading-relaxed text-slate-200 sm:text-2xl tracking-tight opacity-90">
              Gestão financeira estratégica com precisão absoluta. <span className="text-emerald-400 font-bold">Poder total em uma única tela.</span>
            </p>
