...
export function Hero() {
  return (
    <section
      id="inicio"
      className="relative isolate flex items-center overflow-hidden bg-hero-bg pt-[4.75rem] pb-5 text-hero-fg sm:min-h-[46svh] sm:max-h-[560px] sm:pb-8 sm:pt-20 lg:pt-24"
    >
      <img
        src={heroBg}
        alt=""
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-10 bg-[image:var(--hero-veil-mobile)] backdrop-blur-[7px] sm:bg-[image:var(--hero-veil-desktop)] sm:backdrop-blur-[6px] dark:opacity-80 opacity-60"
      />
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 -z-10 backdrop-blur-[14px] [mask-image:linear-gradient(to_right,transparent_0%,rgba(0,0,0,0.35)_38%,rgba(0,0,0,0.85)_68%,rgba(0,0,0,1)_100%)] sm:backdrop-blur-[18px]"
      />
