                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-2">
                  {cat.items.map((item, itemIdx) => (
                    <Reveal key={item.title} delay={(catIdx * 100) + (itemIdx * 50)}>
                      ...
                      >
                        <button className="group relative flex w-full flex-col items-start rounded-xl p-5 text-left transition-all hover:bg-card/10 hover:shadow-[0_0_30px_-12px_rgba(31,174,109,0.2)] active:scale-[0.98]">
