...
export function KidsLoginScreen({ children }: { children: ReactNode }) {
  return (
    <main className="relative isolate grid min-h-dvh w-full place-items-center overflow-x-hidden bg-[oklch(0.15_0.05_260)] p-3 font-sans sm:p-4 lg:h-dvh lg:max-h-dvh lg:min-h-0 lg:overflow-hidden">
      ...
      <div className="grid w-full max-w-4xl grid-cols-1 overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-[0_24px_90px_-24px_rgba(0,0,0,0.65)] backdrop-blur-xl lg:h-[min(38rem,calc(100dvh-2rem))] lg:max-h-[38rem] lg:min-h-[420px] lg:grid-cols-[1.1fr_minmax(0,19rem)]">
        ...
        <section className="relative flex flex-col justify-between overflow-hidden lg:flex">
          ...
          <div
            aria-hidden="true"
            className="absolute inset-0 -z-10 bg-[linear-gradient(to_top,oklch(0.14_0.04_255/0.96)_0%,oklch(0.14_0.04_255/0.75)_45%,oklch(0.14_0.04_255/0.3)_100%)]"
          />
          <div
            aria-hidden="true"
