...
function ConfirmDialogView({
  ...
  return (
    <AlertDialog open={state.open} onOpenChange={(open) => {
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <div className={cn("mb-2 flex h-20 w-20 items-center justify-center rounded-2xl shadow-sm sm:h-24 sm:w-24", iconColor)}>
            {state.type === "warning" ? (
              <svg width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="animate-in zoom-in duration-500 sm:h-12 sm:w-12">
